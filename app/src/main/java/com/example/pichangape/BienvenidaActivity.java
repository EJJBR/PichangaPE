...
import com.example.pichangape.ui.theme.RegistrarCanchasActivity;
...
public class BienvenidaActivity extends AppCompatActivity {
    ...
    private Button btnRegistrarCancha;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnRegistrarCancha = findViewById(R.id.btnRegistrarCancha);

        // Configura el listener para el clic
        btnRegistrarCancha.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Crea un intent explícito a la actividad RegistrarCanchasActivity
                Intent intent = new Intent(BienvenidaActivity.this, com.example.pichangape.ui.theme.RegistrarCanchasActivity.class);
                startActivity(intent);
                // No uses finish() aquí si quieres poder volver a la pantalla de login
            }
        });
